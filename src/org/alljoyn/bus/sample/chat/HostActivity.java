...
public class HostActivity extends Activity implements Observer {
    ...
    static final int DIALOG_SET_NAME_ID = 2;
    static final int DIALOG_START_ID = 3;
    static final int DIALOG_STOP_ID = 4;
    public static final int DIALOG_ALLJOYN_ERROR_ID = 6;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUsername.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
					int count) {
				mChatApplication.setNickname(s.toString());
     ...
     mJoinButton.setOnClickListener(new View.OnClickListener() {
      ...
      mLeaveButton.setOnClickListener(new View.OnClickListener() {
        ...
        mDeleteButton = (Button)findViewById(R.id.deleteMessages);
        mDeleteButton.setEnabled(true);
        mDeleteButton.setOnClickListener(new View.OnClickListener() {
        	public void onClick(View v) {
        		mChatApplication.deleteHistory();
        	}
        });
